...
async def run_daily_pipeline(target_date: date | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        external_data = ExternalDataCreate(
            ...
            rub_usd_pair_desc=CurrencyPair.RUB_USD,
            rub_cny=rates["rub_cny"],
            rub_cny_pair_desc=CurrencyPair.RUB_CNY,
            rub_eur=rates.get("rub_eur"),
            rub_eur_pair_desc=CurrencyPair.RUB_EUR if rates.get("rub_eur") else None,
            rub_inr=rates.get("rub_inr"),
            rub_inr_pair_desc=CurrencyPair.RUB_INR if rates.get("rub_inr") else None,
            rub_aed=rates.get("rub_aed"),
            rub_aed_pair_desc=CurrencyPair.RUB_AED if rates.get("rub_aed") else None,
            trace_id=trace_id,
            sources={
